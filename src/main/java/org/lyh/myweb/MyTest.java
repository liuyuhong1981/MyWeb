...
public class MyTest {
    ...
    private static void testXMLObjectTransform() {
    ...
    private static <T extends User> FluentIterable<T> getAvailableOptionValuesByFamilyIntent(String familyIntent, String type,
